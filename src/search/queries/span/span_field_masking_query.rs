...
/// _lying_ about their search field. The span field masking query maps to Lucene’s
/// `SpanFieldMaskingQuery`
///
/// This can be used to support queries like `span-near` or `span-or` across different fields,
