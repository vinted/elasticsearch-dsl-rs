use super::params::*;
use super::Query;
use crate::{Distance, GeoPoint, ShouldSkip, Time};
...
/// # use chrono::prelude::*;
/// # let query =
/// DistanceFeatureQuery::new("test", Utc.ymd(2014, 7, 8).and_hms(9, 1, 0), Time::Days(7))
///     .boost(1.5)
///     .name("test");
/// ```
/// or
...
/// # use elasticsearch_dsl::queries::params::*;
/// # let query =
/// DistanceFeatureQuery::new("test", GeoPoint::coordinates(12.0, 13.0), Distance::Kilometers(15))
///     .boost(1.5)
///     .name("test");
/// ```
/// or
...
/// # use elasticsearch_dsl::queries::params::*;
/// # let query =
/// DistanceFeatureQuery::new("test", Utc.ymd(2014, 7, 8).and_hms(9, 1, 0), Distance::Kilometers(15))
///     .boost(1.5)
///     .name("test");
/// ```
///
...
impl Query {
    ...
    pub fn distance_feature<O: Origin>(
        ...
        DistanceFeatureQuery::new(field, origin, pivot)
    }
}
...
impl<O: Origin> DistanceFeatureQuery<O> {
    ...
    /// [distance unit](https://www.elastic.co/guide/en/elasticsearch/reference/current/common-options.html#distance-units)
    /// , such as `1km` or `12m`.
    pub fn new(field: impl Into<String>, origin: O, pivot: <O as Origin>::Pivot) -> Self {
        Self {
            inner: Inner {
                field: field.into(),
                origin,
